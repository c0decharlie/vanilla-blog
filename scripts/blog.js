...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let namespace = __webpack_require__(1);
	    let helpers = __webpack_require__(3);
	    let localService = __webpack_require__(13);
	    let postModel = __webpack_require__(14);
	    let postListModel = __webpack_require__(15);
	    let commentModel = __webpack_require__(16);
	    let addPostForm = __webpack_require__(17);
	    let postCommentForm = __webpack_require__(38);
	    let post = __webpack_require__(40);
	    let comment = __webpack_require__(42);
	    let blogController = __webpack_require__(44);

	    let scss = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let eventEmmiter = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let shortid = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let addPostFormTemplate = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"post-form\" name=\"post-form\">\r\n    <label for=\"title\">Post title:</label>\r\n    <input type=\"text\" class=\"form-control\" name=\"title\" id=\"title\" placeholder=\"Title\" required>\r\n    <label for=\"author\">Your Name:</label>\r\n    <input type=\"text\" class=\"form-control\" name=\"author\" id=\"author\" placeholder=\"Author\" required>\r\n    <label for=\"content\">Write your post here:</label>\r\n    <textarea id=\"content\" class=\"control\" name=\"content\" placeholder=\"Content\" required></textarea>\r\n    <input id=\"add-post\" type=\"submit\" class=\"btn btn-primary post-button\" value=\"Post\">\r\n</form>\r\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let postCommentFormTemplate = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form class=\"comment-form\">\r\n    <label for=\"\">Your name:</label>\r\n    <input type=\"text\" class=\"form-control comment-author\" name=\"author\" id=\"comment-author-"
	    + container.escapeExpression(((helper = (helper = helpers["post-id"] || (depth0 != null ? depth0["post-id"] : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"post-id","hash":{},"data":data}) : helper)))
	    + "\" placeholder=\"Author\"\r\n           required>\r\n    <label for=\"\">Comment:</label>\r\n    <textarea class=\"form-control comment-text\" name=\"content\" placeholder=\"Write your comment here\"></textarea>\r\n    <input type=\"submit\" class=\"btn comment-add\" value=\"Add\">\r\n</form>\r\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let postTemplate = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    let commentTemplate = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  font-family: \"Open sans\", sans-serif;\n  background-color: #ecf0f1; }\n\n.create-post {\n  border-bottom: 3px solid #3498db;\n  background-color: #fff;\n  padding: 10px 40px 15px 40px;\n  border-radius: 10px;\n  margin-bottom: 60px;\n  margin-top: 50px;\n  -webkit-box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75);\n  -moz-box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75);\n  box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75); }\n  .create-post h1 {\n    font-family: \"Lobster\", cursive;\n    font-size: 60px; }\n  .create-post input {\n    margin-bottom: 10px; }\n  .create-post textarea {\n    width: 100%;\n    resize: none;\n    height: 80px; }\n  .create-post .post-button {\n    float: right;\n    margin-top: 20px;\n    font-weight: bold; }\n  .create-post:after {\n    content: \"\";\n    display: block;\n    clear: both; }\n\n.post {\n  background: #fff;\n  margin-top: 20px;\n  padding: 10px 40px 15px 40px;\n  border-radius: 10px;\n  margin-bottom: 45px;\n  border-bottom: 3px solid #1abc9c;\n  -webkit-box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75);\n  -moz-box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75);\n  box-shadow: 0px 11px 37px -13px rgba(0, 0, 0, 0.75); }\n  .post .post-title h2 {\n    font-weight: bold; }\n  .post .post-author {\n    float: left;\n    font-style: italic;\n    color: #95a5a6; }\n  .post .post-date {\n    float: right;\n    font-style: italic;\n    color: #95a5a6; }\n  .post .post-content {\n    clear: both;\n    margin-top: 20px; }\n  .post .post-comments {\n    background: #fff;\n    border-top: 1px solid #f2f2f2;\n    margin-top: 25px; }\n    .post .post-comments h4 {\n      font-weight: bold; }\n    .post .post-comments input, .post .post-comments textarea, .post .post-comments label {\n      display: block; }\n    .post .post-comments input {\n      margin-bottom: 10px; }\n    .post .post-comments textarea {\n      width: 100%;\n      resize: none; }\n    .post .post-comments:after {\n      content: '';\n      display: block;\n      clear: both; }\n    .post .post-comments .comment-add {\n      background-color: #1abc9c;\n      color: #fff;\n      font-weight: bold;\n      margin-top: 15px;\n      float: right; }\n      .post .post-comments .comment-add:hover, .post .post-comments .comment-add:focus {\n        color: #fff;\n        background: #1abc9c; }\n    .post .post-comments .comments {\n      margin-bottom: 20px; }\n      .post .post-comments .comments .comment {\n        border-left: 2px solid #1abc9c;\n        border-bottom: 1px solid #f2f2f2;\n        background-color: #f2f2f2;\n        padding-left: 20px;\n        padding-bottom: 15px;\n        padding-top: 15px;\n        margin-bottom: 15px; }\n        .post .post-comments .comments .comment .comment-data span {\n          font-size: 12px;\n          font-style: italic; }\n", ""]);
